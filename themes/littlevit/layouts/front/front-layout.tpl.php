       ...
       <ul class="usage__list">
         ...
         <li class="usage__item">
           <div class="usage__age">
              <div class="usage__icon usage__icon--child">&nbsp;</div>
              <div class="usage__descr">дітям віком</div>
              <div class="usage__value">старше 7-ми років</div>
           </div>
           <div class="usage__dose">2 мл на добу</div>
         </li>
       </ul>
       ...
       <ul class="usage__list">
         ...
         <li class="usage__item">
           <div class="usage__step">
             ...
             <div class="usage__guide">Використовувати за рекомендацією лікаря як додаткове джерело вітамінів.</div>
           </div>
         </li>
       </ul>
    </div>
